...
namespace ProjectUtils.Helpers
{
    public static class Transitions
    {
        ...
        /// </summary>
        public static Coroutine DoScale(this Transform transform, Vector3 targetScale, float time, TimeScales timeScale = TimeScales.Unscaled)  =>  CoroutineController.Start(DoScaleEnumerator(transform, targetScale, time, timeScale));
